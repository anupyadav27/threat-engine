    ...
    <div className="flex flex-wrap items-center gap-2">
      {filters.map((filter) => {
        ...
        return (
          <select
            ...
            style={{
              backgroundColor: currentValue ? 'rgba(59,130,246,0.12)' : 'var(--bg-tertiary)',
              borderColor: currentValue ? 'rgba(59,130,246,0.5)' : 'var(--border-primary)',
      ...
      {hasActiveFilters && (
        <button
          ...
          className="flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium hover:opacity-75 transition-colors duration-200"
