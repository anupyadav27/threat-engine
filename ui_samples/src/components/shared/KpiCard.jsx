...
export default function KpiCard({
  ...
  return (
    <div style={{ backgroundColor: 'var(--bg-card)', borderColor: 'var(--border-primary)' }} className="rounded-xl p-4 border hover:border-opacity-75 transition-colors duration-200">
      {/* Top Row: Icon & Title */}
      <div className="flex items-center justify-between mb-2.5">
        ...
        <div className="flex-1 ml-3">
          <p style={{ color: 'var(--text-tertiary)' }} className="text-xs font-medium">{title}</p>
        </div>
      </div>
