...
export default function InventoryPage() {
  ...
  const getCategoryCount = (services) =>
    assets.filter((a) => services.includes(a.service)).length;

  const getCategoryFindings = (services) =>
    assets
      .filter((a) => services.includes(a.service))
      .reduce(
        (acc, a) => ({
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {categoryBreakdown.map((category) => {
            const count = getCategoryCount(category.services);
            const findings = getCategoryFindings(category.services);
