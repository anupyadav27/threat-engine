...
class ScanOrchestrator:
    ...
    def run_scan_from_discovery(
        ...
        Args:
            configscan_scan_id: Configscan discovery scan ID
        ...
        for discovery_record in discovery_reader.read_discovery_records(configscan_scan_id):
            ...
            normalizer = AssetNormalizer(self.tenant_id, scan_run_id)
            raw_ref = f"discovery:{configscan_scan_id}:{discovery_record.get('discovery_id', 'unknown')}"
