    ...
    def __init__(self, output_base_path: Optional[str] = None):
        ...
        Args:
            output_base_path: Base path to inventory output.
                            Default: engines-output/inventory-engine/output
        """
        if output_base_path is None:
            output_base_path = os.getenv("INVENTORY_OUTPUT_DIR", "/Users/apple/Desktop/threat-engine/engines-output/inventory-engine/output")
