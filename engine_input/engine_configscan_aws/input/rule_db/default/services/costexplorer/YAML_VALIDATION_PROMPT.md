# COSTEXPLORER YAML Rules Validation Prompt
...
**YAML**: `rules/costexplorer.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/costexplorer/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service costexplorer --region us-east-1
```
...
### Validation Summary
```markdown
## COSTEXPLORER Validation Results
