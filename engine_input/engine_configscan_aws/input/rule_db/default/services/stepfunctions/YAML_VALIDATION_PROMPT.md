# STEPFUNCTIONS YAML Rules Validation Prompt
...
**YAML**: `rules/stepfunctions.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/stepfunctions/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service stepfunctions --region us-east-1
```
...
### Validation Summary
```markdown
## STEPFUNCTIONS Validation Results
