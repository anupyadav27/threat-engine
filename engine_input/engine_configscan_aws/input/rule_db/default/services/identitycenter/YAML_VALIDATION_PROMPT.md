# IDENTITYCENTER YAML Rules Validation Prompt
...
**YAML**: `rules/identitycenter.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/identitycenter/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service identitycenter --region us-east-1
```
...
### Validation Summary
```markdown
## IDENTITYCENTER Validation Results
