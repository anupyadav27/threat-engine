# KINESISANALYTICS YAML Rules Validation Prompt
...
**YAML**: `rules/kinesisanalytics.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/kinesisanalytics/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service kinesisanalytics --region us-east-1
```
...
### Validation Summary
```markdown
## KINESISANALYTICS Validation Results
