# WAFV2 YAML Rules Validation Prompt
...
**Service**: `wafv2`  
**YAML**: `rules/wafv2.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/wafv2/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service wafv2 --region us-east-1
```
