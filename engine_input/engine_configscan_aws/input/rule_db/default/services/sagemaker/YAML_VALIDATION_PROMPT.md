# SAGEMAKER YAML Rules Validation Prompt
...
**Service**: `sagemaker`  
**YAML**: `rules/sagemaker.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/sagemaker/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service sagemaker --region us-east-1
```
