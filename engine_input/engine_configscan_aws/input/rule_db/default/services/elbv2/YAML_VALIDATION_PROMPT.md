# ELBV2 YAML Rules Validation Prompt
...
**Service**: `elbv2`  
**YAML**: `rules/elbv2.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/elbv2/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service elbv2 --region us-east-1
```
