# CLOUDFRONT YAML Rules Validation Prompt
...
**Service**: `cloudfront`  
**YAML**: `rules/cloudfront.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/cloudfront/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service cloudfront --region us-east-1
```
