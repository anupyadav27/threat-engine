# FIREHOSE YAML Rules Validation Prompt
...
**Service**: `firehose`  
**YAML**: `rules/firehose.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/firehose/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service firehose --region us-east-1
```
