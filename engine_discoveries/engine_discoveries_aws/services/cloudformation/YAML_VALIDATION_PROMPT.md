# CLOUDFORMATION YAML Rules Validation Prompt
...
**YAML**: `rules/cloudformation.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/cloudformation/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service cloudformation --region us-east-1
```
