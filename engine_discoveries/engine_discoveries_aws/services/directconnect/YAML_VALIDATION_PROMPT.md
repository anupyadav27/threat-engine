# DIRECTCONNECT YAML Rules Validation Prompt
...
**YAML**: `rules/directconnect.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/directconnect/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service directconnect --region us-east-1
```
...
### Validation Summary
```markdown
## DIRECTCONNECT Validation Results
