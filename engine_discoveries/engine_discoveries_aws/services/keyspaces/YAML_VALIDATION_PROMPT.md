# KEYSPACES YAML Rules Validation Prompt
...
**Service**: `keyspaces`  
**YAML**: `rules/keyspaces.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/keyspaces/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service keyspaces --region us-east-1
```
