# ACCOUNT YAML Rules Validation Prompt
...
**Service**: `account`  
**YAML**: `rules/account.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/account/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service account --region us-east-1
```
