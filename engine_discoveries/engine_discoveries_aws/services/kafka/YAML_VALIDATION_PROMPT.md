# KAFKA YAML Rules Validation Prompt
...
**Service**: `kafka`  
**YAML**: `rules/kafka.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/kafka/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service kafka --region us-east-1
```
