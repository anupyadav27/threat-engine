# ATHENA YAML Rules Validation Prompt
...
**Service**: `athena`  
**YAML**: `rules/athena.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/athena/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service athena --region us-east-1
```
