# NEPTUNE YAML Rules Validation Prompt
...
**Service**: `neptune`  
**YAML**: `rules/neptune.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/neptune/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service neptune --region us-east-1
```
