# BUDGETS YAML Rules Validation Prompt
...
**Service**: `budgets`  
**YAML**: `rules/budgets.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/budgets/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service budgets --region us-east-1
```
