# OPENSEARCH YAML Rules Validation Prompt
...
**Service**: `opensearch`  
**YAML**: `rules/opensearch.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/opensearch/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service opensearch --region us-east-1
```
