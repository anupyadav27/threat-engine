# TRANSFER YAML Rules Validation Prompt
...
**Service**: `transfer`  
**YAML**: `rules/transfer.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/transfer/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service transfer --region us-east-1
```
