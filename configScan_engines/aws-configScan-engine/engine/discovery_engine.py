...
class DiscoveryEngine:
    ...
    def _process_single_service(self, service: str, scan_id: str, customer_id: str,
        ...
        try:
            # Check if service has discoveries file
            discoveries_file = Path(f"services/{service}/discoveries/{service}.discoveries.yaml")
        ...
        try:
            ...
            for discovery_id, items in discovery_results.items():
                if items:
                    ...
                    # Prepare records for output files only
