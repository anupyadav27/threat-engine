# ROUTE53 YAML Rules Validation Prompt
...
**Service**: `route53`  
**YAML**: `rules/route53.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/route53/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service route53 --region us-east-1
```
