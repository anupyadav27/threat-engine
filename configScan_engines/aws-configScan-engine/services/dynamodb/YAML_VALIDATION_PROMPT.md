# DYNAMODB YAML Rules Validation Prompt
...
**Service**: `dynamodb`  
**YAML**: `rules/dynamodb.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/dynamodb/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service dynamodb --region us-east-1
```
