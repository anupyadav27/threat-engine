# CONFIG YAML Rules Validation Prompt
...
**Service**: `config`  
**YAML**: `rules/config.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/config/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service config --region us-east-1
```
