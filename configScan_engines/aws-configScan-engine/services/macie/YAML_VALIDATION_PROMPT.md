# MACIE YAML Rules Validation Prompt
...
**Service**: `macie`  
**YAML**: `rules/macie.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/macie/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service macie --region us-east-1
```
