# BATCH YAML Rules Validation Prompt
...
**Service**: `batch`  
**YAML**: `rules/batch.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/batch/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service batch --region us-east-1
```
