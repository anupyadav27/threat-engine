# PARAMETERSTORE YAML Rules Validation Prompt
...
**YAML**: `rules/parameterstore.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/parameterstore/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service parameterstore --region us-east-1
```
...
### Validation Summary
```markdown
## PARAMETERSTORE Validation Results
