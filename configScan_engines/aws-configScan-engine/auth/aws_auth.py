...
def get_boto3_session(default_region: Optional[str] = None) -> boto3.session.Session:
    ...
    # If running under IRSA (web identity), botocore will automatically assume the role via
    # AssumeRoleWithWebIdentity using AWS_ROLE_ARN + AWS_WEB_IDENTITY_TOKEN_FILE.
    # Do NOT call sts:AssumeRole here (can fail due to self-assume restrictions).
