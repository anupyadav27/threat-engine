"""
Generate prioritized resource operations file for GCP services.
        ...
        try:
            ...
            for disc in discovery:
                ...
                if discovery_id:
                    ...
                    # Format: gcp.service.resource.operation
...
def generate_all_services(base_dir: Path):
    ...
    print("="*80)
    print("GENERATING PRIORITIZED RESOURCE OPERATIONS FOR ALL GCP SERVICES")
    print("="*80)
