"""
Generate prioritized resource operations file for IBM services.
        ...
        try:
            ...
            for disc in discovery:
                ...
                if discovery_id:
                    ...
                    # Format: alicloud.service.OperationName (PascalCase)
                    parts = discovery_id.split('.')
                    if len(parts) >= 3:
                        op_name = parts[2]  # Already PascalCase for alicloud
...
def generate_all_services(base_dir: Path):
    ...
    print("="*80)
    print("GENERATING PRIORITIZED RESOURCE OPERATIONS FOR ALL IBM SERVICES")
    print("="*80)
