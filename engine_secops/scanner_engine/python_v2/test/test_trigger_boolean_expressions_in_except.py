...
def test_trigger_boolean_expression_except():
    try:
        x = 1 / 0
    except (Exception and True):  # Should trigger: boolean expression in except statement
        pass

def test_no_trigger_explicit_exception():
    try:
        x = 1 / 0
...
if __name__ == "__main__":
    test_trigger_boolean_expression_except()
    test_no_trigger_explicit_exception()
