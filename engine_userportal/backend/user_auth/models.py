...
# Admin scope for landlord, customer_admin, group_admin, tenant roles.
# Super landlord has no scope (role check only).
# scope_type: 'customer' | 'tenant' | 'landlord'; scope_id: customer_id, tenant_id, or user_id.
class UserAdminScope(models.Model):
    SCOPE_TYPES = (("customer", "customer"), ("tenant", "tenant"), ("landlord", "landlord"))
    ...
    scope_type = models.CharField(max_length=32, choices=SCOPE_TYPES)
