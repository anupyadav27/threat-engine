"""
FastAPI server for IBM Compliance Engine
"""
import sys
import os
...
logger = setup_logger(__name__, engine_name="configscan-ibm")

app = FastAPI(
    title="IBM Compliance Engine API",
    description="API for running IBM compliance scans",
    version="1.0.0"
)

# Add logging middleware
app.add_middleware(CorrelationIDMiddleware)
app.add_middleware(RequestLoggingMiddleware, engine_name="configscan-ibm")
