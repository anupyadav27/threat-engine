# APPSYNC YAML Rules Validation Prompt
...
**Service**: `appsync`  
**YAML**: `rules/appsync.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/appsync/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service appsync --region us-east-1
```
