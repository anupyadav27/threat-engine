# ELASTICACHE YAML Rules Validation Prompt
...
**Service**: `elasticache`  
**YAML**: `rules/elasticache.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/elasticache/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service elasticache --region us-east-1
```
...
### Validation Summary
```markdown
## ELASTICACHE Validation Results
