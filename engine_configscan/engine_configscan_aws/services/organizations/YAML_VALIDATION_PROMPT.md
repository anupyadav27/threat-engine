# ORGANIZATIONS YAML Rules Validation Prompt
...
**YAML**: `rules/organizations.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/organizations/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service organizations --region us-east-1
```
...
### Validation Summary
```markdown
## ORGANIZATIONS Validation Results
