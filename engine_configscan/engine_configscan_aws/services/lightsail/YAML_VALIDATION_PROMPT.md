# LIGHTSAIL YAML Rules Validation Prompt
...
**Service**: `lightsail`  
**YAML**: `rules/lightsail.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/lightsail/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service lightsail --region us-east-1
```
