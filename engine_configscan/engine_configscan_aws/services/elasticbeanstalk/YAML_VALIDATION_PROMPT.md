# ELASTICBEANSTALK YAML Rules Validation Prompt
...
**YAML**: `rules/elasticbeanstalk.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/elasticbeanstalk/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service elasticbeanstalk --region us-east-1
```
...
### Validation Summary
```markdown
## ELASTICBEANSTALK Validation Results
