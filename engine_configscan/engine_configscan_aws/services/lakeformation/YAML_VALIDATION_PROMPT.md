# LAKEFORMATION YAML Rules Validation Prompt
...
**YAML**: `rules/lakeformation.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/lakeformation/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service lakeformation --region us-east-1
```
...
### Validation Summary
```markdown
## LAKEFORMATION Validation Results
