# KINESISFIREHOSE YAML Rules Validation Prompt
...
**YAML**: `rules/kinesisfirehose.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/kinesisfirehose/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service kinesisfirehose --region us-east-1
```
...
### Validation Summary
```markdown
## KINESISFIREHOSE Validation Results
