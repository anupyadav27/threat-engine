# CLOUDTRAIL YAML Rules Validation Prompt
...
**Service**: `cloudtrail`  
**YAML**: `rules/cloudtrail.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/cloudtrail/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service cloudtrail --region us-east-1
```
