# KINESIS YAML Rules Validation Prompt
...
**Service**: `kinesis`  
**YAML**: `rules/kinesis.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/kinesis/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service kinesis --region us-east-1
```
