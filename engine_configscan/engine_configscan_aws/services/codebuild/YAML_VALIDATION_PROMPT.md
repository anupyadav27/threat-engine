# CODEBUILD YAML Rules Validation Prompt
...
**Service**: `codebuild`  
**YAML**: `rules/codebuild.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/codebuild/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service codebuild --region us-east-1
```
