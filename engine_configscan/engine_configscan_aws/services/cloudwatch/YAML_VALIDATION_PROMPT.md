# CLOUDWATCH YAML Rules Validation Prompt
...
**Service**: `cloudwatch`  
**YAML**: `rules/cloudwatch.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/cloudwatch/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service cloudwatch --region us-east-1
```
