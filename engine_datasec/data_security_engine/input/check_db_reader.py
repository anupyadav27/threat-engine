...
Reads check_results from threat_engine_check and filters by data-security-relevant rules.
...
class CheckDBReader:
    ...
    def load_datasec_check_results(
        ...
        """
        Load data-security-relevant check results from check_results table.
