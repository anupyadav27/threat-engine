...
class AliCloudCIEMProvider(BaseCIEMProvider):
    ...
    def get_parsers(self) -> Dict[str, Type]:
        from ciem_engine.parser.actiontrail_parser import ActionTrailParser
        return {
            "alicloud_actiontrail": ActionTrailParser,
        }

    def get_readers(self) -> Dict[str, Type]:
        from ciem_engine.reader.alicloud_actiontrail_reader import AliCloudActionTrailReader
        return {
