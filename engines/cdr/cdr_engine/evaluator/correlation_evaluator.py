...
Reads L1 findings from cdr_findings + raw events from log_events,
...
class CorrelationEvaluator:
    ...
    def _create_correlation_finding(
        ...
        return {
            ...
            "status": "OPEN",
            "primary_engine": scenario.get("engine", "cdr"),
            "engines": [scenario.get("engine", "cdr")],
    ...
    def _write_findings(self, findings: List[Dict]):
        """Write correlation findings to cdr_findings."""
        if not findings:
            return
