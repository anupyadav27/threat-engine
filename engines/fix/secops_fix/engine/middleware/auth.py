...
Configuration:
  SECOPS_FIX_API_KEY  — required env var; engine refuses to start without it.
...
class APIKeyMiddleware(BaseHTTPMiddleware):
    ...
    - Logs all auth failures with client IP (never logs the submitted key value).
    """
