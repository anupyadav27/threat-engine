...
async def remediate(
    request: VulFixRequest,
    raw_req: Request,
    auth: Any = Depends(require_permission("scans:create") if _AUTH_AVAILABLE else (lambda: None)),
):  # noqa: C901
    """
    ...
    Authentication:
      ...
      - X-Auth-Context / access_token — scans:create permission required (viewer/analyst blocked)
