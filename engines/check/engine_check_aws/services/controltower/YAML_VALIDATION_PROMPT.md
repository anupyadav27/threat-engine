# CONTROLTOWER YAML Rules Validation Prompt
...
**YAML**: `rules/controltower.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/controltower/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service controltower --region us-east-1
```
...
### Validation Summary
```markdown
## CONTROLTOWER Validation Results
