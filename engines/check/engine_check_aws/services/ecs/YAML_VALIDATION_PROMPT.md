# ECS YAML Rules Validation Prompt
...
**Boto3 Reference**: `pythonsdk-database/aws/ecs/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service ecs --region us-east-1
```
