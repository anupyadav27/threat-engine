# SAVINGSPLANS YAML Rules Validation Prompt
...
**YAML**: `rules/savingsplans.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/savingsplans/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service savingsplans --region us-east-1
```
...
### Validation Summary
```markdown
## SAVINGSPLANS Validation Results
