# KMS YAML Rules Validation Prompt
...
**Boto3 Reference**: `pythonsdk-database/aws/kms/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service kms --region us-east-1
```
