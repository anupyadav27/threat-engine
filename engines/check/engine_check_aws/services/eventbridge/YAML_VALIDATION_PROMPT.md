# EVENTBRIDGE YAML Rules Validation Prompt
...
**Service**: `eventbridge`  
**YAML**: `rules/eventbridge.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/eventbridge/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service eventbridge --region us-east-1
```
