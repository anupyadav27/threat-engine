# FARGATE YAML Rules Validation Prompt
...
**Service**: `fargate`  
**YAML**: `rules/fargate.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/fargate/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service fargate --region us-east-1
```
