# ACCESSANALYZER YAML Rules Validation Prompt
...
**YAML**: `rules/accessanalyzer.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/accessanalyzer/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service accessanalyzer --region us-east-1
```
...
### Validation Summary
```markdown
## ACCESSANALYZER Validation Results
