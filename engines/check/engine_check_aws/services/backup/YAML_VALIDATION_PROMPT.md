# BACKUP YAML Rules Validation Prompt
...
**Service**: `backup`  
**YAML**: `rules/backup.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/backup/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service backup --region us-east-1
```
