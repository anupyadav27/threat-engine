# WORKSPACES YAML Rules Validation Prompt
...
**Service**: `workspaces`  
**YAML**: `rules/workspaces.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/workspaces/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service workspaces --region us-east-1
```
