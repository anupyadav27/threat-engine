# TIMESTREAM YAML Rules Validation Prompt
...
**Service**: `timestream`  
**YAML**: `rules/timestream.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/timestream/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service timestream --region us-east-1
```
