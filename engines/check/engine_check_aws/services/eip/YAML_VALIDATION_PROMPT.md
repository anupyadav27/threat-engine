# EIP YAML Rules Validation Prompt
...
**Boto3 Reference**: `pythonsdk-database/aws/eip/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service eip --region us-east-1
```
