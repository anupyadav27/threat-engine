# INSPECTOR YAML Rules Validation Prompt
...
**Service**: `inspector`  
**YAML**: `rules/inspector.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/inspector/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service inspector --region us-east-1
```
