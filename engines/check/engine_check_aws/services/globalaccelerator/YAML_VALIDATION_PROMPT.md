# GLOBALACCELERATOR YAML Rules Validation Prompt
...
**YAML**: `rules/globalaccelerator.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/globalaccelerator/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service globalaccelerator --region us-east-1
```
...
### Validation Summary
```markdown
## GLOBALACCELERATOR Validation Results
