# SHIELD YAML Rules Validation Prompt
...
**Service**: `shield`  
**YAML**: `rules/shield.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/shield/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service shield --region us-east-1
```
