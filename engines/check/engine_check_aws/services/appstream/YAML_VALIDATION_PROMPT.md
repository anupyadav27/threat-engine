# APPSTREAM YAML Rules Validation Prompt
...
**Service**: `appstream`  
**YAML**: `rules/appstream.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/appstream/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service appstream --region us-east-1
```
