# WORKFLOWS YAML Rules Validation Prompt
...
**Service**: `workflows`  
**YAML**: `rules/workflows.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/workflows/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service workflows --region us-east-1
```
