# GLACIER YAML Rules Validation Prompt
...
**Service**: `glacier`  
**YAML**: `rules/glacier.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/glacier/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service glacier --region us-east-1
```
