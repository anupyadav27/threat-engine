# VPC YAML Rules Validation Prompt
...
**Boto3 Reference**: `pythonsdk-database/aws/vpc/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service vpc --region us-east-1
```
