# DIRECTORYSERVICE YAML Rules Validation Prompt
...
**YAML**: `rules/directoryservice.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/directoryservice/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service directoryservice --region us-east-1
```
...
### Validation Summary
```markdown
## DIRECTORYSERVICE Validation Results
