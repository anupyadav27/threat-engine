# parameterstore Metadata Review and Consolidation Prompt

You are an expert AWS compliance engineer reviewing metadata mappings and metadata files for the **parameterstore** service. Your task is to analyze and provide actionable suggestions for consolidations and cross-service placements.

## Service Context

**Service Name**: `parameterstore`  
**Service Path**: `/Users/apple/Desktop/threat-engine/aws_compliance_python_engine/services/parameterstore/`
...
- `rule_id`: Uni   acque identifier for the rule
...
**Path**: `/Users/apple/Desktop/threat-engine/pythonsdk-database/aws/parameterstore/boto3_dependencies_with_python_names_fully_enriched.json`

Contains actual AWS API method specifications to validate method ownership.

## Your Task

Analyze the parameterstore service and provide:
...
{{
  ...
  "consolidation_suggestions": {{
    "duplicates": [
      {{
        "keep": {{
          "rule_id": "aws.parameterstore.resource.check_complete",
          "metadata_file": "aws.parameterstore.resource.check_complete.yaml",
        ...
        "remove": [
          {{
            "rule_id": "aws.parameterstore.resource.check_basic",
            "metadata_file": "aws.parameterstore.resource.check_basic.yaml",
            "replaced_by": "aws.parameterstore.resource.check_complete",
  ...
  "cross_service_suggestions": [
    {{
      "rule_id": "aws.parameterstore.resource.check_name",
      "metadata_file": "aws.parameterstore.resource.check_name.yaml",
      "current_service": "parameterstore",
...
2. **Service Prefix Matching**
   - Extract service from rule_id: `aws.parameterstore.{{resource}}.{{check}}`
...
1. **Load all files** for parameterstore service
...
**Begin Review**: Analyze the parameterstore service files and generate comprehensive review JSON.
