...
def test_generator():
    ...
    service_list = Path(__file__).parent.parent.parent / "engine_configscan" / "engine_configscan_aws" / "config" / "service_list.json"
    relation_types = Path(__file__).parent.parent.parent / "engine_inventory" / "inventory_engine" / "config" / "relation_types.json"
