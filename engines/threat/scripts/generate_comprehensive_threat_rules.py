...
def main():
    ...
    parser.add_argument(
        "--service-list",
        default=str(_root / "engine_configscan" / "engine_configscan_aws" / "config" / "service_list.json"),
        help="Path to service_list.json"
    )
    parser.add_argument(
        "--relation-types",
        default=str(_root / "engine_inventory" / "inventory_engine" / "config" / "relation_types.json"),
        help="Path to relation_types.json"
    )
    parser.add_argument(
        "--output",
        default=str(_root / "engine_threat" / "threat_engine" / "config" / "threat_rules.yaml"),
