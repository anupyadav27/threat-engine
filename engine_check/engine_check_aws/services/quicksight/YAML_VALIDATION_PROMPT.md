# QUICKSIGHT YAML Rules Validation Prompt
...
**Service**: `quicksight`  
**YAML**: `rules/quicksight.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/quicksight/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service quicksight --region us-east-1
```
