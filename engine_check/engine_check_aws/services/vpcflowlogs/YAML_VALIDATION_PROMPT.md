# VPCFLOWLOGS YAML Rules Validation Prompt
...
**Service**: `vpcflowlogs`  
**YAML**: `rules/vpcflowlogs.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/vpcflowlogs/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service vpcflowlogs --region us-east-1
```
...
### Validation Summary
```markdown
## VPCFLOWLOGS Validation Results
