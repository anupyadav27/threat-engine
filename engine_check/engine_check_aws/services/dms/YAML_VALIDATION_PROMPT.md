# DMS YAML Rules Validation Prompt
...
**Boto3 Reference**: `pythonsdk-database/aws/dms/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service dms --region us-east-1
```
