# timestream Metadata Review and Consolidation Prompt

You are an expert AWS compliance engineer reviewing metadata mappings and metadata files for the **timestream** service. Your task is to analyze and provide actionable suggestions for consolidations and cross-service placements.

## Service Context

**Service Name**: `timestream`  
**Service Path**: `/Users/apple/Desktop/threat-engine/aws_compliance_python_engine/services/timestream/`
...
**Path**: `/Users/apple/Desktop/threat-engine/pythonsdk-database/aws/timestream/boto3_dependencies_with_python_names_fully_enriched.json`

Contains actual AWS API method specifications to validate method ownership.

## Your Task

Analyze the timestream service and provide:
...
{{
  ...
  "consolidation_suggestions": {{
    "duplicates": [
      {{
        "keep": {{
          "rule_id": "aws.timestream.resource.check_complete",
          "metadata_file": "aws.timestream.resource.check_complete.yaml",
        ...
        "remove": [
          {{
            "rule_id": "aws.timestream.resource.check_basic",
            "metadata_file": "aws.timestream.resource.check_basic.yaml",
            "replaced_by": "aws.timestream.resource.check_complete",
  ...
  "cross_service_suggestions": [
    {{
      "rule_id": "aws.timestream.resource.check_name",
      "metadata_file": "aws.timestream.resource.check_name.yaml",
...
2. **Service Prefix Matching**
   - Extract service from rule_id: `aws.timestream.{{resource}}.{{check}}`
...
1. **Load all files** for timestream service
...
**Begin Review**: Analyze the timestream service files and generate comprehensive review JSON.
