# AUTOSCALING YAML Rules Validation Prompt
...
**Service**: `autoscaling`  
**YAML**: `rules/autoscaling.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/autoscaling/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service autoscaling --region us-east-1
```
...
### Validation Summary
```markdown
## AUTOSCALING Validation Results
