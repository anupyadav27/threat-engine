# BEDROCK YAML Rules Validation Prompt
...
**Service**: `bedrock`  
**YAML**: `rules/bedrock.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/bedrock/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service bedrock --region us-east-1
```
