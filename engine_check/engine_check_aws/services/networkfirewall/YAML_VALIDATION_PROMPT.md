# NETWORKFIREWALL YAML Rules Validation Prompt
...
**YAML**: `rules/networkfirewall.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/networkfirewall/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service networkfirewall --region us-east-1
```
...
### Validation Summary
```markdown
## NETWORKFIREWALL Validation Results
