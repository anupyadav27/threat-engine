# ELASTIC YAML Rules Validation Prompt
...
**Service**: `elastic`  
**YAML**: `rules/elastic.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/elastic/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service elastic --region us-east-1
```
