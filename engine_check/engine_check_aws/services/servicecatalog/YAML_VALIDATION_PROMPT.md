# SERVICECATALOG YAML Rules Validation Prompt
...
**YAML**: `rules/servicecatalog.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/servicecatalog/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service servicecatalog --region us-east-1
```
...
### Validation Summary
```markdown
## SERVICECATALOG Validation Results
