# GUARDDUTY YAML Rules Validation Prompt
...
**Service**: `guardduty`  
**YAML**: `rules/guardduty.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/guardduty/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service guardduty --region us-east-1
```
