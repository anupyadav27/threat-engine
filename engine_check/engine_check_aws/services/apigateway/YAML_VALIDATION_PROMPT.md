# APIGATEWAY YAML Rules Validation Prompt
...
**Service**: `apigateway`  
**YAML**: `rules/apigateway.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/apigateway/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service apigateway --region us-east-1
```
