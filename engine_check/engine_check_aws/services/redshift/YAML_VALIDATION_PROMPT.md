# REDSHIFT YAML Rules Validation Prompt
...
**Service**: `redshift`  
**YAML**: `rules/redshift.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/redshift/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service redshift --region us-east-1
```
