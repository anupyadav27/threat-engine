# DETECTIVE YAML Rules Validation Prompt
...
**Service**: `detective`  
**YAML**: `rules/detective.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/detective/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service detective --region us-east-1
```
