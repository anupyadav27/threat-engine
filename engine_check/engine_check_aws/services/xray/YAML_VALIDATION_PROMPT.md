# XRAY YAML Rules Validation Prompt
...
**Service**: `xray`  
**YAML**: `rules/xray.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/xray/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service xray --region us-east-1
```
