# S3 YAML Rules Validation Prompt
...
**Boto3 Reference**: `pythonsdk-database/aws/s3/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service s3 --region us-east-1
```
