...
for db in threat_engine_shared threat_engine_check threat_engine_discoveries threat_engine_compliance threat_engine_inventory threat_engine_threat; do
...
psql_ -d threat_engine_check       -f "$SCHEMAS_DIR/check_schema.sql"
psql_ -d threat_engine_discoveries -f "$SCHEMAS_DIR/discoveries_schema.sql"
...
echo "Done. DBs: threat_engine_shared, threat_engine_check, threat_engine_discoveries, threat_engine_compliance, threat_engine_inventory, threat_engine_threat"
