...
// Demo data removed — all table data now comes from the risk engine via BFF
...
export default function RiskPage() {
  ...
  const riskRegister      = rawRiskRegister;
  const mitigationRoadmap = rawMitigationRoadmap;
  const scenariosDisplay  = rawScenariosData;
