...
import IdentityRiskHeatmap from '@/components/ciem/IdentityRiskHeatmap';
...
export default function CiemPage() {
  ...
  const { data, loading, error, refetch } = useViewFetch('ciem');
  ...
  useEffect(() => {
    fetchView('ciem/heatmap').then(result => {
