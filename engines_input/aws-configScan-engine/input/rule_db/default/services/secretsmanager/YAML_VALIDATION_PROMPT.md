# SECRETSMANAGER YAML Rules Validation Prompt
...
**YAML**: `rules/secretsmanager.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/secretsmanager/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service secretsmanager --region us-east-1
```
...
### Validation Summary
```markdown
## SECRETSMANAGER Validation Results
