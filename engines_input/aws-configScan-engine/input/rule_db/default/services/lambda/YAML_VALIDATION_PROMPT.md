# LAMBDA YAML Rules Validation Prompt
...
**Service**: `lambda`  
**YAML**: `rules/lambda.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/lambda/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service lambda --region us-east-1
```
