# KINESISVIDEOSTREAMS YAML Rules Validation Prompt
...
**YAML**: `rules/kinesisvideostreams.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/kinesisvideostreams/`
...
```yaml
# rules/kinesisvideostreams.yaml
- rule_id: {rule_id}
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service kinesisvideostreams --region us-east-1
```
...
### Validation Summary
```markdown
## KINESISVIDEOSTREAMS Validation Results
