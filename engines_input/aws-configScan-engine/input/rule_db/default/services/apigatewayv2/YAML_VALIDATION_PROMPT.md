# APIGATEWAYV2 YAML Rules Validation Prompt
...
**YAML**: `rules/apigatewayv2.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/apigatewayv2/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service apigatewayv2 --region us-east-1
```
...
### Validation Summary
```markdown
## APIGATEWAYV2 Validation Results
