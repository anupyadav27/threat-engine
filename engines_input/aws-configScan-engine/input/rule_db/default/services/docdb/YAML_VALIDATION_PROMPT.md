# DOCDB YAML Rules Validation Prompt
...
**Service**: `docdb`  
**YAML**: `rules/docdb.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/docdb/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service docdb --region us-east-1
```
