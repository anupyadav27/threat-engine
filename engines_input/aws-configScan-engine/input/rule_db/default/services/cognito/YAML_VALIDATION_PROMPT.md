# COGNITO YAML Rules Validation Prompt
...
**Service**: `cognito`  
**YAML**: `rules/cognito.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/cognito/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service cognito --region us-east-1
```
