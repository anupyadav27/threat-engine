# DATASYNC YAML Rules Validation Prompt
...
**Service**: `datasync`  
**YAML**: `rules/datasync.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/datasync/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service datasync --region us-east-1
```
