# EC2 YAML Rules Validation Prompt
...
**Boto3 Reference**: `pythonsdk-database/aws/ec2/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service ec2 --region us-east-1
```
