    ...
    def __init__(self, base_path: Optional[Path] = None):
        ...
        Args:
            base_path: Base directory for threat engine output
                      Default: engines-output/aws-configScan-engine/output/configscan/rule_check
        """
        if base_path is None:
            workspace_root = Path("/Users/apple/Desktop/threat-engine")
            base_path = workspace_root / "engines-output" / "aws-configScan-engine" / "output" / "configscan" / "rule_check"
