# WELLARCHITECTED YAML Rules Validation Prompt
...
**YAML**: `rules/wellarchitected.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/wellarchitected/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service wellarchitected --region us-east-1
```
...
### Validation Summary
```markdown
## WELLARCHITECTED Validation Results
