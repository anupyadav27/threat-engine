# STORAGEGATEWAY YAML Rules Validation Prompt
...
**YAML**: `rules/storagegateway.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/storagegateway/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service storagegateway --region us-east-1
```
...
### Validation Summary
```markdown
## STORAGEGATEWAY Validation Results
