# SECURITYHUB YAML Rules Validation Prompt
...
**Service**: `securityhub`  
**YAML**: `rules/securityhub.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/securityhub/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service securityhub --region us-east-1
```
...
### Validation Summary
```markdown
## SECURITYHUB Validation Results
