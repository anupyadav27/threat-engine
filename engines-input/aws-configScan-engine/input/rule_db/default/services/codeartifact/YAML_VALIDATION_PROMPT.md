# CODEARTIFACT YAML Rules Validation Prompt
...
**YAML**: `rules/codeartifact.yaml`  
**Metadata**: `metadata/*.yaml`  
**Boto3 Reference**: `pythonsdk-database/aws/codeartifact/`
...
PYTHONPATH=/Users/apple/Desktop/threat-engine python3 -m aws_compliance_python_engine.engine.main_scanner --service codeartifact --region us-east-1
```
...
### Validation Summary
```markdown
## CODEARTIFACT Validation Results
